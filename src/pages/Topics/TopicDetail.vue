              ...
              <div class="title-line">
                ...
                <template v-else>
                  <div class="inline-edit-wrapper">
                    <a-input v-model:value="editingTitle" size="small" style="width: 300px" @pressEnter="saveTitle" />
                    <a-button type="primary" size="small" @click="saveTitle">保存</a-button>
                    <a-button size="small" @click="isEditingTitle = false">取消</a-button>
                  </div>
                </template>
                ...
                <template v-else>
                  <div class="edit-tags-wrapper">
                    <a-select
                      ...
                      :token-separators="[',', ' ']"
                    />
                    <a-button type="primary" size="small" @click="saveTags">保存</a-button>
                    <a-button size="small" @click="isEditingTags = false">取消</a-button>
                  </div>
                </template>
              </div>
              <div class="desc-line">
                ...
                <template v-else>
                  <div class="inline-edit-wrapper desc-edit">
                    <a-textarea v-model:value="editingDesc" :rows="2" style="width: 400px" />
                    <div class="desc-actions">
                      <a-button type="primary" size="small" @click="saveDesc">保存</a-button>
                      <a-button size="small" @click="isEditingDesc = false">取消</a-button>
                    </div>
                  </div>
                </template>
              </div>
          ...
          <div class="usage-section">
            <div class="usage-toolbar">
              <template v-if="!isEditingNote">
                <a-button v-if="canEdit" type="primary" ghost size="small" @click="startEditNote">
                  <template #icon><EditOutlined /></template>
                  编辑
                </a-button>
              </template>
              <template v-else>
                <a-button type="primary" size="small" @click="saveNote">保存</a-button>
                <a-button size="small" @click="cancelEditNote">取消</a-button>
              </template>
            </div>
            <div v-if="!isEditingNote" class="usage-card">
              ...
              <div v-else class="usage-empty">
                ...
                <p>暂无使用说明</p>
                <a-button v-if="canEdit" type="primary" ghost size="small" @click="startEditNote">开始编写</a-button>
              </div>
            </div>
            <a-textarea
              v-else
...
async function saveTableChanges() {
  ...
  for (const id of addedIds) {
    ...
    if (table) await addTableToTopic(topicId.value, table)
  }
...
async function saveTags() {
  await updateTopic(topicId.value, {
    ...topic.value,
    tags: editingTags.value.slice(0, 3)
  })
  await loadTopic()
