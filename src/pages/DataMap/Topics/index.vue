<template>
  <div class="topics-page">
    ...
    <a-modal
      ...
      okText="创建"
      cancelText="取消"
      :okButtonProps="{ disabled: !createForm.name.trim(), class: 'custom-modal-btn' }"
...
import { getTopics, createTopic, updateTopic, deleteTopic, toggleFollow } from '@/services/DataMap/topicService.js'
