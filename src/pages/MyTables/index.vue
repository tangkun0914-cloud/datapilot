  ...
  <div class="mytables-page">
    ...
    <div class="mytables-body">
      ...
      <div class="table-card">
        ...
        />
        <TableGroup v-else-if="activeTab === 'favorites'" :tables="filteredFavorites" empty-text="暂无收藏的表" />
        <TableGroup v-else-if="activeTab === 'recent'" :tables="filteredRecent" empty-text="暂无访问记录" />
      </div>
    </div>
...
import { transferTables } from '@/services/tableService'
